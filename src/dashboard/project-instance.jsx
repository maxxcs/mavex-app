      ...
      <div className="flex-row full center-alt">
        ...
        <div className="flex-row project-instance-menu">
          <Whisper delay={250} placement="top" trigger="hover" speaker={<Tooltip>Invite</Tooltip>}>
            <a className="highlight" onClick={() => Alert.success('So much invitation, very collaborative!')}>
              <Icon icon="send-o"  style={{ fontSize: 18 }} />
            </a>
          </Whisper> 
          <Whisper delay={250} placement="topLeft" trigger="hover" speaker={<Tooltip>Edit</Tooltip>}>
            <a className="highlight" onClick={() => Alert.warning('So much edition, very hackable!')}>
